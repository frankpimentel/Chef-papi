...
function extractSector(address) {
  ...
  // Check all known sectors and return the matching one capitalized
  ...
  // Try to extract last meaningful part of address as sector
...
// START
// ============================================================
app.listen(PORT, () => console.log(`🍗 Chef Papi v30 running on port ${PORT}`));
