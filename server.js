...
// ── FLAVORS ──────────────────────────────────────────────────
const FLAVORS = {
  natural:  { title: "Natural (Sal y Pimienta)", emoji: "🧂" },
...
(como "qué lo qué", "ta bien", "brutal", "qué nivel", "qué e' lo que e'", "mano", "brother", "wepa").
NUNCA uses "diay" ni "tío" — esas son expresiones costarricenses y españolas, no dominicanas.
...
// START
// ============================================================
app.listen(PORT, () => console.log(`🍗 Chef Papi v19 running on port ${PORT}`));
